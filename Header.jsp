...
<form>
	...
	<td align=""><font face="arial narrow" size="5px" color="Yellow"><b> BUG Detector System</b></font></td>
	</tr>
	<tr>
	...
	String role=(String)hs.getAttribute("role");
	 %>
	   <td align="right" valign="bottom" colspan=2>
                ...
                <b>[ <%if(role.equals("admin")){%><a href="./Admin Home.jsp"><%} else if(uname.equals("Tester")){%><a href="./TesterHome.jsp?cat=Tester"><%} else if(uname.equals("Developer")){%><a href="./DeveloperHome.jsp?cat=Developer&uname=<%=uname%>"><%}else if(uname.equals("HrManager")){%><a href="./HrMangerHome.jsp?cat=HrMangager&uname=<%=uname%>"><%} %><font color="#FBC61">home</font></a> ]</b>&nbsp;
