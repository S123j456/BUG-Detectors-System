...
<body bgcolor="silver">
<form  name="proj" action="ViewProject.jsp">
<center>
...
<a href="javascript:show_calendar('document.editform.sdate', document.editform.sdate.value);">Date</a>
</tr>
...
<tr>
  ...
  <td><textarea name="caddress" name="clientaddress" cols="20" rows="3"></textarea></td>
  </tr>
   
<tr>
  <td>&nbsp;Phone No:</td>
  <td><input type="text" name="clientphoneno" value=""></td>
</tr>

<tr>
  <td>&nbsp;EmailId:</td>
  <td><input type="text" name="clientmail" value=""></td>
</tr>
